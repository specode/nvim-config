...
1. Make sure your terminal uses JetBrains Mono Nerd Font Mono (required for icons; covers both ASCII and CJK). Recommended: set up your terminal first with my dotfiles — https://github.com/specode/dotfiles
